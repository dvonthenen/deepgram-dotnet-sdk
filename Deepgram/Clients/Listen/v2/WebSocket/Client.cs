...
public class Client : AbstractWebSocketClient, IListenWebSocketClient
{
        ...
        Dictionary<string, string>? headers = null)
    {
        ...
        try
        {
            ...
            await base.Connect(myURI.ToString(), cancelToken, headers);
        ...
        void StartKeepAliveBackgroundThread() => Task.Run(() => ProcessKeepAlive());

        void StartAutoFlushBackgroundThread() => Task.Run(() => ProcessAutoFlush());
    }
    ...
    private async void InspectMessage(object type, JsonDocument data)
    {
