...
public static class ClientFactory
{
    ...
    /// This method allows you to create an AnalyzeClient with a specific version of the client.
    /// </summary>
    public static object CreateListenWebSocketClient(int version, string apiKey = "", DeepgramWsClientOptions? options = null, string? httpId = null)
    {
    ...
    /// </summary>
    public static object CreateSpeakWebSocketClient(int version, string apiKey = "", DeepgramHttpClientOptions? options = null, string? httpId = null)
    {
        // at some point this needs to be changed to use reflection to get the type of the client
        switch (version)
        {
